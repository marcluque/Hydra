 ...
 * Simply implement it, but use the {@link de.datasec.hydra.shared.protocol.packets.listener.PacketHandler} for methods
 * that are supposed to handle a packet. See the examples for more accurate information on the correct usage of the
